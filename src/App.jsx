...
// Rôles avec accès "gestionnaire" (biens, locataires, admin…)
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#F7F5F0', display:'flex', alignItems:'center', justifyContent:'center', padding:16 }}>
      <div style={{ background:'#fff', borderRadius:16, padding:32, maxWidth:440, width:'100%', border:'1px solid rgba(0,0,0,.08)' }}>
        ...
        <div style={{ background:'#FDF6E3', border:'1px solid #f0d58a', borderRadius:8, padding:'10px 14px', fontSize:13, color:'#B87E20', marginBottom:10 }}>
...
// Guard — si pas de rôle requis ou si le rôle est dans la liste → OK
// Sinon → redirect accueil
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      {/* Réservé propriétaire / agence / admin / gestionnaire */}
